...
#include <memory>
#include "../../Interface/mytcpclient.h"
...
QT_MOC_LITERAL(1, 12, 4), // "Auth"
QT_MOC_LITERAL(2, 17, 0), // ""
QT_MOC_LITERAL(3, 18, 8), // "FailAuth"
QT_MOC_LITERAL(4, 27, 3), // "Reg"
QT_MOC_LITERAL(5, 31, 7), // "FailReg"
QT_MOC_LITERAL(6, 39, 14), // "slot_connected"
QT_MOC_LITERAL(7, 54, 14), // "slot_readyRead"
QT_MOC_LITERAL(8, 69, 19), // "slot_send_to_server"
QT_MOC_LITERAL(9, 89, 7), // "message"
QT_MOC_LITERAL(10, 97, 17) // "slot_disconnected"

    },
    "MyTcpClient\0Auth\0\0FailAuth\0Reg\0FailReg\0"
    "slot_connected\0slot_readyRead\0"
...
void MyTcpClient::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->FailAuth(); break;
        case 2: _t->Reg(); break;
        case 3: _t->FailReg(); break;
        case 4: _t->slot_connected(); break;
        case 5: _t->slot_readyRead(); break;
        case 6: _t->slot_send_to_server((*reinterpret_cast< QString(*)>(_a[1]))); break;
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyTcpClient::Auth)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (MyTcpClient::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyTcpClient::FailAuth)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (MyTcpClient::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyTcpClient::Reg)) {
                *result = 2;
                return;
            }
        }
        {
            using _t = void (MyTcpClient::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyTcpClient::FailReg)) {
                *result = 3;
                return;
            }
        }
...
// SIGNAL 0
void MyTcpClient::Auth()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void MyTcpClient::FailAuth()
{
    QMetaObject::activate(this, &staticMetaObject, 1, nullptr);
}

// SIGNAL 2
void MyTcpClient::Reg()
{
    QMetaObject::activate(this, &staticMetaObject, 2, nullptr);
}

// SIGNAL 3
void MyTcpClient::FailReg()
{
